...
class ProjectPath(BasePath):
    ...
    # 获取 用例数据 data 路径
    DATA_PATH = os.path.join(ROOT_PATH, 'data_测试数据_02')

    # 配置文件路径
    CONFIG_PATH = os.path.join(ROOT_PATH, 'setting_配置文件_4')

    # 测试用例方法路径
    CASE_PATH = os.path.join(ROOT_PATH, 'test_case_测试用例方法_3')

    # 存放测试报告路径
    REPORT_PATH = os.path.join(ROOT_PATH, '存放测试报告')
